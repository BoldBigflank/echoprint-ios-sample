...
//            } else {
//                NSLog(@"No Errors loading audio");
//                _audioPlayer.delegate = self;
//                [_audioPlayer prepareToPlay];
//                [_audioPlayer play];
//                [_audioPlayer setVolume:1.0F];
//                [_audioPlayer setCurrentTime:timeDiff + riff_offset]; // Add the riff_offset and the difference of time fingerprinting
//            }
            [recorder playRiff:song_title offset:timeDiff+riff_offset];
